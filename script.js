...
var data = {
    ...
    "cn": {
        ...
        "contact": "联系方式",
        "bgc": "设置主题颜色",
        "quote": "你无法控制人们对你的评价和他们对你的想法。你无法为厄运做好准备。说实话，你只能尽力而为。最后，最重要的是努力。其余的超出你的控制范围。 ― 玛丽亚·莎拉波娃（Maria Sharapova），《不可阻挡：我的人生》",
        "description_title": "个人简介",
        "description": "我是一个全栈软件工程师",
        "about_me_title": "关于我",
        "self_introduction": "英属哥伦比亚（卑诗）大学大四计算机在读本科生。来自上海，善于自我管理，追求完美，具有很强的压力承受能力和超乎预期的热情。",
        "soccer": "我是皇家马德里铁粉！信仰白色！永远的马德里主义者！我也是一名蓝魔，支持家乡球队上海申花！",
        "tech_skills": "专业技能",
